...
function rex_shop_blaettern(&$gg, $aid=0, $params = array(), $anzahl = 10)
{
	...
	if ($g==0) $von = 0;
		...
		$return = '<table class="rex-table" style="font-size:12px;"><tr><td style="text-align:center"><a href="'.$links.'"><span>&laquo;</span></a> | <a>'.$von." - ".$bis.' of '.$g.'</a> | <a href="'.$rechts.'"><span>&raquo;</span></a></td></tr></table>';
